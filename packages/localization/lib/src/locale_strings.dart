...
class LocaleStrings {
  ...
  static String get exploreHotelButton => 'explore.hotel_button'.tr();

  static String get exploreThingsTodoButton => 'explore.things_button'.tr();

  static String get exploreRestaurantButton => 'explore.restaurant_button'.tr();

  static String get exploreForumsButton => 'explore.forums_button'.tr();

  static String get exploreKeepExploringButton =>
      'explore.keep_exploring_button'.tr();

  static String get exploreDiscoverTitle => 'explore.discover_title'.tr();

  static String get exploreLikeThisTile => 'explore.like_this_tile'.tr();

  static String get exploreMoreThingsTile => 'explore.more_things_tile'.tr();

  static String get explorePerfectWeekendContainerHeading =>
      'explore.perfect_weekend_image_container_heading'.tr();

  static String get explorePerfectWeekendContainerSubHeading =>
      'explore.perfect_weekend_image_container_subHeading'.tr();
